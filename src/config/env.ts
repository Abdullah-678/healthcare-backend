...
interface EnvConfig {
  ...
  BETTER_AUTH_SECRET_TOKEN_EXPIRES_IN: string;
...
const loadEnvVariables = (): EnvConfig => {
  const requiredEnvVariable = [
    ...
    "BETTER_AUTH_SECRET_TOKEN_EXPIRES_IN",
  ...
  return {
    ...
    BETTER_AUTH_SECRET_TOKEN_EXPIRES_IN: process.env
      .BETTER_AUTH_SECRET_TOKEN_EXPIRES_IN as string,
